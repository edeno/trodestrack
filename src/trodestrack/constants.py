...
SPIKEGADGETS_ACCEL_SCALE_FACTOR_G_PER_LSB: Final[float] = (
    0.000061  # Raw accelerometer to g conversion
)
SPIKEGADGETS_GYRO_SCALE_FACTOR_DEGPS_PER_LSB: Final[float] = (
    0.061  # Raw gyroscope to deg/s conversion
)
...
MIN_VELOCITY_THRESHOLD_CM_S: Final[float] = (
    1e-6  # Minimum velocity in cm/s to avoid division by zero
)
