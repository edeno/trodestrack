...
class HomographyCalibrator:
    ...
    def on_reset(self, event):
        ...
        self.fig.canvas.draw()
        print("Reset completed. Click 4 corners in order: Top-Left, Top-Right, Bottom-Right, Bottom-Left")
    ...
    def run_calibration(self) -> Optional[np.ndarray]:
        ...
        self.ax.set_title(f'Homography Calibration - {self.image_path.name}\\n'
        ...
        instruction_text = (f"Arena size: {self.arena_width_cm} x {self.arena_height_cm} cm\\n"
