...
def run_online(args: argparse.Namespace) -> None:
    ...
    if args.camera_mask is not None:
        ...
        # rows as valid frames. Reject anything that isn't an exact 0 / 1 / False
        # / True so a corrupted mask file fails loudly rather than inflating
        # the valid-frame count.
